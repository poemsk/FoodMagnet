package com.poepoemyintswe.foodmagnet.ui.widget;
...
public class FlowLayout extends ViewGroup {
  ...
  private void init() {
    paddingHorizontal = getResources().getDimensionPixelSize(R.dimen.spacing_minor);
    paddingVertical = getResources().getDimensionPixelSize(R.dimen.spacing_minor);
  }
